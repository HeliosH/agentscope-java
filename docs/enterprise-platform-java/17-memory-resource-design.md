...
> 2026-07-12 更新：本文保留当前记忆/文件/沙箱资源实现的演进记录。岗位主数据、个人记忆卡片、Mem0 投影治理和任务前检索的目标方案，以 [18. 企业岗位档案与个人记忆实施方案](./18-enterprise-memory-profile-implementation.md) 为准。当前“对话消息直接投递 Mem0”属于待替换的过渡路径。
