...
-- Seed tier policies and a demo organization + users (H2 local profile).
-- Demo passwords are BCrypt hashes of "password" (cost 10).
...
INSERT INTO users (id, org_id, email, display_name, password_hash, role, tier) VALUES
    ('00000000-0000-0000-0000-0000000000a1',
     ...
     '$2a$10$WwF9lmAWvZhEf60W/U42zORFlrwF.BFRNoj1nlHJYyLaw/7qpwWJ.', 'admin', 'privileged'),
    ('00000000-0000-0000-0000-0000000000a2',
     '00000000-0000-0000-0000-000000000001',
     'alice@demo.local', 'Alice',
     '$2a$10$WwF9lmAWvZhEf60W/U42zORFlrwF.BFRNoj1nlHJYyLaw/7qpwWJ.', 'member', 'standard'),
